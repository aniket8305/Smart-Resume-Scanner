      ...
      >
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 dark:text-slate-400">
              Fine-tune the candidate evaluation formula ({totalWeight}% total weight)
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <span className="text-xs font-semibold text-indigo-600 dark:text-indigo-400">
            Tech {weights.technicalSkills}% • Exp {weights.experience}% • Edu {weights.education}% • Keyword {weights.keywordMatch}%
          </span>
          {isOpen ? (
      ...
      {isOpen && (
        <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            ...
            />
            <span className="text-[10px] text-slate-400">Required & bonus tech stacks</span>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full h-1.5 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-indigo-600 dark:bg-slate-700"
            />
            <span className="text-[10px] text-slate-400">Seniority & track record</span>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full h-1.5 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-indigo-600 dark:bg-slate-700"
            />
            <span className="text-[10px] text-slate-400">Degrees and certifications</span>
          </div>

          {/* Keyword / Context Weight */}
          <div>
            <div className="flex justify-between text-xs mb-1">
              <span className="font-semibold text-slate-700 dark:text-slate-300">
                Context / TF-IDF
            ...
            <input
              ...
              className="w-full h-1.5 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-indigo-600 dark:bg-slate-700"
            />
            <span className="text-[10px] text-slate-400">Semantic & domain similarity</span>
          </div>
